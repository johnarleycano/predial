...
$seccion1->addText("BYRON ARTURO ARBOLEDA CANO", 'titulo2', $alineacion_centrada);
$seccion1->addText("C.C Nº 71.759.850", 'parrafo2', $alineacion_centrada);
$seccion1->addText("T.P Nº 182222 del C.S de la Judicatura", 'parrafo2', $alineacion_centrada);
