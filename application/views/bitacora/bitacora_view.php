		...
		<div id="principal">
			<div id="contenido">
				<div id="form">
					...
					<div id="dialog-form" title="Agregar nueva entrada" style="background-color: white;">
					...
					<div id="dialog-form-editar" title="Editar entrada" style="background-color: white;">
						<?php echo form_fieldset('Todos los datos son requeridos.'); ?>
